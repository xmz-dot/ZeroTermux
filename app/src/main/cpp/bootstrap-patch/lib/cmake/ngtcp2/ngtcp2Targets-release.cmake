...
set_target_properties(ngtcp2::ngtcp2 PROPERTIES
  IMPORTED_LOCATION_RELEASE "/data/data/com.tarmux/files/usr/lib/libngtcp2.so"
  IMPORTED_SONAME_RELEASE "libngtcp2.so"
  )

list(APPEND _cmake_import_check_targets ngtcp2::ngtcp2 )
list(APPEND _cmake_import_check_files_for_ngtcp2::ngtcp2 "/data/data/com.tarmux/files/usr/lib/libngtcp2.so" )
...
set_target_properties(ngtcp2::ngtcp2_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/data/data/com.tarmux/files/usr/lib/libngtcp2.a"
  )

list(APPEND _cmake_import_check_targets ngtcp2::ngtcp2_static )
list(APPEND _cmake_import_check_files_for_ngtcp2::ngtcp2_static "/data/data/com.tarmux/files/usr/lib/libngtcp2.a" )
...
set_target_properties(ngtcp2::ngtcp2_crypto_ossl PROPERTIES
  IMPORTED_LOCATION_RELEASE "/data/data/com.tarmux/files/usr/lib/libngtcp2_crypto_ossl.so"
  IMPORTED_SONAME_RELEASE "libngtcp2_crypto_ossl.so"
  )

list(APPEND _cmake_import_check_targets ngtcp2::ngtcp2_crypto_ossl )
list(APPEND _cmake_import_check_files_for_ngtcp2::ngtcp2_crypto_ossl "/data/data/com.tarmux/files/usr/lib/libngtcp2_crypto_ossl.so" )
...
set_target_properties(ngtcp2::ngtcp2_crypto_ossl_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "/data/data/com.tarmux/files/usr/lib/libngtcp2_crypto_ossl.a"
  )

list(APPEND _cmake_import_check_targets ngtcp2::ngtcp2_crypto_ossl_static )
list(APPEND _cmake_import_check_files_for_ngtcp2::ngtcp2_crypto_ossl_static "/data/data/com.tarmux/files/usr/lib/libngtcp2_crypto_ossl.a" )
