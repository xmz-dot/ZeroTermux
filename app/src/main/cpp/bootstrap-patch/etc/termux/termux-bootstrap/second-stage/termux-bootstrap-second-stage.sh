#!/data/data/com.tarmux/files/usr/bin/bash
# shellcheck shell=bash

export TERMUX_PREFIX="/data/data/com.tarmux/files/usr"
...
run_bootstrap_second_stage() {
	...
	output="$(ln -s "termux-bootstrap-second-stage.sh" \
		"/data/data/com.tarmux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock" 2>&1)"
	return_value=$?
...
then delete the '/data/data/com.tarmux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock' \
...
'/data/data/com.tarmux/files/usr/etc/termux/termux-bootstrap/second-stage/termux-bootstrap-second-stage.sh.lock'"
