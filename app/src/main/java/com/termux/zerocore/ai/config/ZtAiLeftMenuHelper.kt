...
<zt-menu>
    ...
    fun getMenuInfo(): String {
        ...
        if (readId != null) {
            ...
            root.put("note", ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_no_package_note))
        }
    ...
    fun updateMenu(args: JSONObject): String {
        ...
        if (targetsSystemMenu(createPackage)) {
            return errorJson(ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_err_system_menu))
        }
        ...
        when {
            createPackage.isNotEmpty() -> {
                if (!isAiCreateRequest(createPackage)) {
                    return errorJson(ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_err_create_name))
                }
            ...
            fullXml.isNotEmpty() -> {
                ...
                targetPackageId = resolveUpdateTargetPackageId(context, packageIdArg)
                    ?: return errorJson(ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_err_no_update_target))
            ...
            else -> return errorJson(ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_err_need_content))
        }
    ...
    private fun targetsSystemMenu(name: String): Boolean {
        ...
        return lower == MainMenuPackageInfo.ID_PROGRAM.lowercase()
            ...
            || name == UUtils.getString(com.tarmux.R.string.menu_package_program_label)
            || name == UUtils.getString(com.tarmux.R.string.menu_package_default_label)
    }
    ...
    private fun buildSuccessJson(
        ...
        return JSONObject()
            ...
            .put("note", ZtAiStrings.str(com.tarmux.R.string.zt_ai_left_menu_success_note))
            .toString(2)
    }
