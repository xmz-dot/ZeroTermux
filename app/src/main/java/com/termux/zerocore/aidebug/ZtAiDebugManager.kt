...
object ZtAiDebugManager {
    ...
    @Volatile
    var cameraHelper: com.tarmux.zerocore.workstation.ZtWorkstationCameraHelper? = null
        private set
    ...
    fun setCameraHelper(helper: com.tarmux.zerocore.workstation.ZtWorkstationCameraHelper?) {
        cameraHelper = helper
    }
