...
import com.tarmux.zerocore.dialog.OnLineShDialog;
...
public class OnLineCommandClickConfig extends BaseMenuClickConfig {
    ...
    public void onClick(View view, Context context) {
        ...
        mOnLineShDialog.setOnItemClickListener(msg -> {
            com.tarmux.zerocore.utils.SingletonCommunicationUtils.getInstance().getmSingletonCommunicationListener().sendTextToTerminal(msg + "\n");
    ...
    public void showOnLineShDialog(String url, Context context) {
        ...
        mOnLineShDialog.connection();
        mOnLineShDialog.setOnItemClickListener(msg -> {
            com.tarmux.zerocore.utils.SingletonCommunicationUtils.getInstance()
