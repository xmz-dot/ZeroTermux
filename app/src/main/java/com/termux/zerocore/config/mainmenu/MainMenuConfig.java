...
import com.termux.ai.ai.zerocore.config.BaseConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.AdbShellRunClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.BackupRestoreClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.BeautificationSettingsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.BootCommandClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ChangBashClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ChangStartMsgClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ClearStyleClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CloseTurnNetworkAdbClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CommandDefinitionCLickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CommonlyUsedSoftLinksDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ContainerSwitchClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CreateCProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CreateJavaProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CreateNpmProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CreatePhpProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.CreatePythonProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.OpenProjectClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.DataMessageClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.DefBashClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.DockerCheckClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.DownLoadClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FileBrowserClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FixEnvironmentalErrorClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FloatWindowsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FontSettingsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FtpDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.FullScreenClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.GitHubClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.HideCommandClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.HideX11KeyboardClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.InstallModuleClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.InstallX11ClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.KeyDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.LanguageClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.MainMenuClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.MoeClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.MyUsedSoftLinksDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.OnLineCommandClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.OpenPathClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.OpenTurnNetworkAdbClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ParticleClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.PhoneSmsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.PublicWarehouseClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.QEMUClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ReleaseLinuxVersionClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.RemoteConnectionClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ScheduledTaskClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ShowCommandClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ShowX11KeyboardClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.SnowflakeClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.SwitchSourceClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.UnInstallClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.VNCClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.WebDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.WebDataClickConfigImp;
import com.termux.ai.ai.zerocore.config.mainmenu.config.X11EnvironmentClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.X11SettingsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.X86AlpineDataClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ZTCommandKeyClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ZTSettingsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ZeroBBsClickConfig;
import com.termux.ai.ai.zerocore.config.mainmenu.config.ZeroFunctionClickConfig;
